...
import 'home_page.dart'; // We import home_page.dart to get access to the ProductCard widget
...
class _SearchPageState extends State<SearchPage> {
  ...
  // A sample product to display in the search results for demonstration
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // --- The Search Results ---
          // In a real app, this would be a dynamic list based on search filters.
          // For this task, we just show a sample card that navigates to the detail page.
          GestureDetector(
            onTap: () {
